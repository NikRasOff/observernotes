...
## [br][br]
## [b]Edit:[/b] Freely edit the files
## [br][br]
## [b]Select file:[/b] Select one file
## [br][br]
## [b]Select dir:[/b] Select one folder
## [br][br]
## [b]Select file or dir:[/b] Select one file or folder
## [br][br]
## [b]Locked:[/b] Just look at the files
...
func create_file_display(file_path:String, mode:int, is_dir:bool, custom_name:String="") -> FileDisplay:
	var new_file_display := ObsFileDisplay.new(file_path, mode, is_dir, custom_name)
